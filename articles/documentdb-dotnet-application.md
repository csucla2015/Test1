<a name="_Toc395809351">Build a Web Application with ASP.NET MVC using the Azure DocumentDB Service</a>
=======================================================================================================
...
![Alt text](/articles/media/documentdb-dotnet-application/image1.png)
...
![Alt text](/articles/media/documentdb-dotnet-application/image2.png)
...
![Alt text](/articles/media/documentdb-dotnet-application/image3.png)

From here, select the option for Azure DocumentDB

![Alt text](/articles/media/documentdb-dotnet-application/image4.png)


Then select “Create” from the bottom of the screen

![Alt text](/articles/media/documentdb-dotnet-application/image5.png)
...
![Alt text](/articles/media/documentdb-dotnet-application/image6.png)
...
![Alt text](/articles/media/documentdb-dotnet-application/image7.png)
...
![Alt text](/articles/media/documentdb-dotnet-application/image8.png) 
![Alt text](/articles/media/documentdb-dotnet-application/image9.png)
...
![Alt text](/articles/media/documentdb-dotnet-application/image10.png)


Select where you would like to create the project and click Ok.

![Alt text](/articles/media/documentdb-dotnet-application/image11.png)
...
![Alt text](/articles/media/documentdb-dotnet-application/image12.png)
...
![Alt text](/articles/media/documentdb-dotnet-application/image13.png)

![Alt text](/articles/media/documentdb-dotnet-application/image14.png)


In the **Add Scaffold** dialog box, click **MVC 5 Controller - Empty.**
Click **Add.**

![Alt text](/articles/media/documentdb-dotnet-application/image15.png)
...
![Alt text](/articles/media/documentdb-dotnet-application/image16.png)
...
![Alt text](/articles/media/documentdb-dotnet-application/image17.png)
...
![Alt text](/articles/media/documentdb-dotnet-application/image18.png)
...
![Alt text](/articles/media/documentdb-dotnet-application/image19.png)
...
![Alt text](/articles/media/documentdb-dotnet-application/image20.png)
...
![Alt text](/articles/media/documentdb-dotnet-application/image21.png)
...
![Alt text](/articles/media/documentdb-dotnet-application/image22.png)
...
![Alt text](/articles/media/documentdb-dotnet-application/image23.png)
...
![Alt text](/articles/media/documentdb-dotnet-application/image24.png)
...
![Alt text](/articles/media/documentdb-dotnet-application/image25.png)

If you hit Create, you will be redirected back to the Index page and
hopefully your Item shows in the List.

![Alt text](/articles/media/documentdb-dotnet-application/image26.png)
...
![Alt text](/articles/media/documentdb-dotnet-application/image27.png)
...
![Alt text](/articles/media/documentdb-dotnet-application/image28.png)
...
![Alt text](/articles/media/documentdb-dotnet-application/image29.png)
